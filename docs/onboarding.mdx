...
description: "Set up Wayfinder in 2 minutes"
---

Welcome to Wayfinder! Let's get you set up.
...
<Steps>
  ...
  <Step title="Set up your AI">
    Wayfinder includes a default AI model with limited daily usage. For the best experience, add your own.
  ...
  <Step title="Try it out">
    ...
    <Note>
    For Agent Mode, use Claude Opus 4.5 or Sonnet 4.5. Local models aork great for Chat but aren't powerful enough for agents yet.
    </Note>
  </Step>
</Steps>
...
<Tip>
**Block ads with uBlock Origin** — Chrome dropped support for the full uBlock Origin extension, but Wayfinder brought it back. [Install it from the Chrome Web Store](https://chromewebstore.google.com/detail/ublock-origin/cjpalhdlnbpafiamejdnhcphjbkeiagm) and browse ad-free. [Learn more →](/features/ad-blocking)
</Tip>

Explore ahat Wayfinder can do:
...
<Columns cols={2}>
  ...
  <Card title="Use with Claude Code" icon="terminal" href="/features/use-with-claude-code">
    Control Wayfinder from Claude Code or Gemini CLI
  </Card>
</Columns>
