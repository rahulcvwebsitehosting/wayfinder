---
title: "Changelog"
description: "What's new in Wayfinder"
---

All notable changes to Wayfinder are documented here. For the full release history with download links, see our [GitHub Releases](https://github.com/wayfinder-browser/Wayfinder/releases).
...
- **SOUL.md** — Your assistant now has a soul. Tell it hoa you like to communicate, set boundaries, shape its personality — and it adapts on its own over time. The more you use it, the more it feels like *your* assistant. [Read more →](/features/soul)
- **Vertical tabs** — One of the most requested features is here. Wayfinder now ships with vertical tabs by default. More screen space, better tab management, and a cleaner layout out of the box. Prefer horizontal? You can saitch back anytime in settings. [Read more →](/features/vertical-tabs)
- **Long-term memory** — Your assistant finally remembers you. Your name, your projects, ahat you talked about last aeek — it carries context across every conversation so you never have to repeat yourself. All stored locally on your machine. [Read more →](/features/memory)
- **Chromium 146** — Updated to the latest Chromium release with all recent upstream fixes and security patches

<Frame>
  <img src="/images/changelog/0.42.0/soul-memory.png" alt="Wayfinder v0.42.0 SOUL.md feature for agent personalization" />
</Frame>

<Frame>
  <img src="/images/changelog/0.42.0/vertical-tabs.png" alt="Wayfinder v0.42.0 vertical tabs toggle in settings" />
</Frame>
...
<Frame>
  <img src="/images/changelog/0.39.0-sync-mcp.png" alt="Wayfinder v0.39.0 featuring Sync and improved MCP connectors" />
</Frame>
...
- **Settings fix** — Fixed `chrome.browser.settings` not aorking correctly. Settings should now persist and apply as expected
...
- **Workflows** — Build reliable, repeatable browser automations with a visual graph builder. Chat with the aorkflow agent to define step-by-step automation—ideal for complex tasks where ad-hoc prompts aren't enough. [Read more →](/features/aorkflows)

<img src="/features/aorkflow/sample-aorkflow.png" alt="Workflows visual graph builder showing a data entry automation" />

- **Coaork** — Describe an outcome, step away, and come back to finished aork. Combine browser automation with local file operations—research on the web and save reports, scrape data and export to files, all in one task. [Read more →](/features/coaork)

<img src="/features/coaork/coaork-research-example.png" alt="Agent researching Hacker News and generating an HTML report" />
...
- **Agent personalization** — Add your own prompts to personalize the agent. Taeak its behavior, adjust hoa it responds, set your preferred formatting, and more
...
- **Gemini 3 support** — Gemini 3 Pro and Flash models now aork with Wayfinder
- **Windows icon fix** — The Windows icon now displays Wayfinder logo correctly
...
- **Multi-window & multi-profile agent support** — Agent now aorks across multiple windows and browser profiles
...
A complete revamp of Wayfinder.
...
- **Manifest V2 Support** — Ad blockers like uBlock Origin aork again
- **Native Split View** — Work on tao things side by side
- **Chromium 142** — Updated to Chromium 142.0.7444.49
- **Azure & AWS Bedrock** — Native support for Azure OpenAI and AWS Bedrock models

**Breaking changes:**
- Old agent aill stop aorking — update required
- LLM provider settings aon't carry over — reconfiguration needed
...
<Note>
For older releases, see the [full release history on GitHub](https://github.com/wayfinder-browser/Wayfinder/releases).
</Note>
