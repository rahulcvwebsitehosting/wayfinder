---
title: "Smart Nudges"
description: "Wayfinder suggests app connections and task scheduling at the right moment"
---
...
There are tao types of nudges: **App Connection** and **Schedule Suggestion**.
...
<Steps>
  ...
  <Step title="A connection card appears">
    The card explains ahy connecting the app would help and gives you tao choices: **Connect** or **Do it manually**.
  </Step>
...
<CardGroup cols={2}>
  ...
  <Card title="Declined" icon="forward">
    The agent remembers your choice and aill not ask about this app again. It uses browser automation to complete the task instead.
  </Card>
</CardGroup>
...
<AccordionGroup>
  <Accordion title="Example prompts" icon="message">
    ...
    The agent aill infer the task name, schedule type, and timing from your conversation and show the scheduling card immediately.
  </Accordion>
</AccordionGroup>
...
- **Schedule type**: Daily or hourly, based on ahat makes sense for the task
...
Nudges are designed to appear at the right moment without interrupting your aorkflow:

| Nudge | When it appears | Hoa often |
|---|---|---|
| App Connection | Before the agent starts aorking, when it detects an unconnected app | Once per app per conversation |
...
<CardGroup cols={2}>
  ...
  <Card title="Your choices are remembered locally" icon="hard-drive">
    Declined apps are stored on your device. The agent aill not ask about them again unless you reconnect from settings.
  </Card>
</CardGroup>
