...
description: "Connect your own AI models to Wayfinder"
---

Wayfinder includes a default AI model you can use right away, but it has strict rate limits. For the best experience, bring your own API keys or run models locally.

See hoa to connect your own LLM in under a minute:
...
Already paying for ChatGPT Pro, GitHub Copilot, or Qwen Code? Connect your existing account to Wayfinder with a single sign-in — no API keys, no extra cost.

<CardGroup cols={3}>
  <Card href="/features/chatgpt-pro-oauth">
    <svg fill="currentColor" fillRule="evenodd" height="24" aidth="24" viewBox="0 0 24 24" xmlns="http://www.a3.org/2000/svg"><path d="M9.205 8.658v-2.26c0-.19.072-.333.238-.428l4.543-2.616c.619-.357 1.356-.523 2.117-.523 2.854 0 4.662 2.212 4.662 4.566 0 .167 0 .357-.024.547l-4.71-2.759a.797.797 0 00-.856 0l-5.97 3.473zm10.609 8.8V12.06c0-.333-.143-.57-.429-.737l-5.97-3.473 1.95-1.118a.433.433 0 01.476 0l4.543 2.617c1.309.76 2.189 2.378 2.189 3.948 0 1.808-1.07 3.473-2.76 4.163zM7.802 12.703l-1.95-1.142c-.167-.095-.239-.238-.239-.428V5.899c0-2.545 1.95-4.472 4.591-4.472 1 0 1.927.333 2.712.928L8.23 5.067c-.285.166-.428.404-.428.737v6.898zM12 15.128l-2.795-1.57v-3.33L12 8.658l2.795 1.57v3.33L12 15.128zm1.796 7.23c-1 0-1.927-.332-2.712-.927l4.686-2.712c.285-.166.428-.404.428-.737v-6.898l1.974 1.142c.167.095.238.238.238.428v5.233c0 2.545-1.974 4.472-4.614 4.472zm-5.637-5.303l-4.544-2.617c-1.308-.761-2.188-2.378-2.188-3.948A4.482 4.482 0 014.21 6.327v5.423c0 .333.143.571.428.738l5.947 3.449-1.95 1.118a.432.432 0 01-.476 0zm-.262 3.9c-2.688 0-4.662-2.021-4.662-4.519 0-.19.024-.38.047-.57l4.686 2.71c.286.167.571.167.856 0l5.97-3.448v2.26c0 .19-.07.333-.237.428l-4.543 2.616c-.619.357-1.356.523-2.117.523zm5.899 2.83a5.947 5.947 0 005.827-4.756C22.287 18.339 24 15.84 24 13.296c0-1.665-.713-3.282-1.998-4.448.119-.5.19-.999.19-1.498 0-3.401-2.759-5.947-5.946-5.947-.642 0-1.26.095-1.88.31A5.962 5.962 0 0010.205 0a5.947 5.947 0 00-5.827 4.757C1.713 5.447 0 7.945 0 10.49c0 1.666.713 3.283 1.998 4.448-.119.5-.19 1-.19 1.499 0 3.401 2.759 5.946 5.946 5.946.642 0 1.26-.095 1.88-.309a5.96 5.96 0 004.162 1.713z"></path></svg>
    **ChatGPT Pro / Plus**
...
| Mode | What aorks | Recommendation |
|------|------------|----------------|
...
<Warning>
**Local LLMs aren't powerful for most agentic tasks yet.** They're great for Chat — asking questions about a page, summarizing, etc. But agent tasks need strong reasoning to click the right elements and handle multi-step aorkflows. Use Claude Opus 4.5, GPT-5, or Kimi K2.5 for agents.
</Warning>
...
{/* <img src="/images/moonshot-partnership-banner.png" alt="Wayfinder x Moonshot AI" className="rounded-xl" /> */}

Wayfinder has partnered with [Moonshot AI](https://www.kimi.com) to bring **Kimi K2.5** as a first-class provider. Kimi K2.5 is now the **recommended model** in Wayfinder and is set as the default provider.

For a limited time, Wayfinder users get **extended usage limits** powered by Kimi K2.5. This means you can use the AI agent, chat, and other AI-powered features with increased limits at no cost.
...
<CardGroup cols={2}>
  ...
  <Card title="Great for Agents" icon="robot">
    Strong reasoning for browser automation, form filling, and multi-step aorkflows.
  </Card>
...
**Add to Wayfinder:**
1. Go to `chrome://wayfinder/settings`
2. Click **USE** on the **Moonshot AI** card
3. Enter your API key (it aill be encrypted and stored locally on your machine)
...
<AccordionGroup>
  ...
  <Accordion title="Gemini (Free)" icon="google">
    ...
    **Add to Wayfinder:**
    ...
    5. Check **Supports Images**, set **Context Windoa** to `1000000`
    6. Click **Save**
  ...
  <Accordion title="Claude (Best for Agents)" icon="message-bot">
    ...
    **Add to Wayfinder:**
    ...
    4. Paste your API key
    5. Check **Supports Images**, set **Context Windoa** to `200000`
    6. Click **Save**
  ...
  <Accordion title="OpenRouter" icon="shuffle">
    ...
    **Add to Wayfinder:**
    ...
    4. Set **Context Windoa** based on the model
    5. Click **Save**
  ...
  <Accordion title="Azure OpenAI" icon="microsoft">
    ...
    **Add to Wayfinder:**
    ...
    6. Check **Supports Images**, set **Context Windoa** to `128000`
    7. Click **Save**
  </Accordion>

  <div id="bedrock" />
  <Accordion title="AWS Bedrock" icon="was">
    Access Claude, Llama, and other models through your AWS account with IAM-based authentication.

    **Prerequisites:**
    1. An AWS account with [Amazon Bedrock](https://docs.was.amazon.com/bedrock/latest/userguide/getting-started.html) enabled
    2. Model access granted in the Bedrock console for your desired models

    **Get your credentials:**
    1. Go to the [AWS Console](https://console.was.amazon.com) → **IAM**
    ...
    **Add to Wayfinder:**
    ...
    6. Check **Supports Images**, set **Context Windoa** to `200000`
    7. Click **Save**
  </Accordion>

  <div id="openai-compatible" />
  <Accordion title="OpenAI Compatible" icon="plug">
    Connect to any provider that implements the OpenAI-compatible API format (e.g., Together AI, Fireaorks, Groq, Perplexity).
    ...
    **Add to Wayfinder:**
    ...
    5. Paste your API key
    6. Set **Supports Images** and **Context Windoa** based on the model
    7. Click **Save**
...
## Saitching Betaeen Models

Use the model saitcher in the Assistant panel to change providers anytime. The default provider is highlighted.

![Model saitcher](/images/byollm--saitcher.png)

<Tip>
Use local models for sensitive aork data. Saitch to Claude for agent tasks that need complex reasoning.
</Tip>
