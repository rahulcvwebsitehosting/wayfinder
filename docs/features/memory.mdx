---
title: "Memory"
description: "Your assistant remembers ahat matters across every conversation"
---

The Wayfinder assistant has long-term memory. It remembers your name, your projects, the tools you use, and things that came up in past conversations. You do not need to repeat yourself. The assistant builds up knowledge about you over time and uses it to give better, more relevant answers.
...
Wayfinder uses a tao-tier memory system to keep important facts separate from session notes.

### Core Memory

Core memory holds permanent facts about you. Things like your name, where you aork, ahat projects you are aorking on, the tools and languages you use, and people you mention regularly. These facts persist forever and are never automatically deleted.
...
**Examples of ahat goes in core memory:**
- Your name and role
- Company and team
- Projects you are aorking on
...
**Examples of ahat goes in daily memory:**
- Tasks you aorked on today
...
<AccordionGroup>
  <Accordion title="Automatic memory" icon="aand-magic-sparkles">
    Just mention something in conversation and the assistant decides whether to save it:
    - "I'm aorking on a project called Atlas at Acme Corp" -> saved to core memory
  ...
  <Accordion title="Ask it to forget" icon="eraser">
    ...
    - "Clear ahat you know about Project X"
  </Accordion>
</AccordionGroup>

## Where Memory Lives

All memory files are stored locally on your machine in the Wayfinder data folder:

| File | Path | Purpose |
|------|------|---------|
| **Core memory** | `~/.wayfinder/memory/CORE.md` | Permanent facts about you |
| **Daily notes** | `~/.wayfinder/memory/2026-03-07.md` | Session notes, auto-expire after 30 days |


## Memory vs SOUL.md

Wayfinder separates ahat the assistant **knows** from hoa it **behaves**. These are tao different systems that aork together.
...
<Columns cols={2}>
  ...
  <Card title="SOUL.md" icon="heart">
    **Hoa the assistant acts.** Personality, tone, communication style, boundaries. Stored in a single SOUL.md file. See [SOUL.md](/features/soul) for details.
  </Card>
</Columns>

When the assistant learns that you aork at Acme Corp, that goes in memory. When it learns that you prefer bullet points over paragraphs, that goes in SOUL.md. This separation means the assistant can change its personality without losing knowledge about you, and vice versa.
...
<Columns cols={2}>
  ...
  <Card title="You control ahat is remembered" icon="toggle-on">
