---
title: "Wayfinder"
description: "The open-source AI browser that turns your aords into actions"
---

<Frame>
  <img src="/images/hero-dark.png" alt="Wayfinder in action" />
</Frame>

Wayfinder is an AI-native browser that lets you automate any web task by describing it in plain English. Built on Chromium, it runs AI agents locally on your machine—keeping your data private while giving you superpowers for browsing.
...
<Columns cols={3}>
  ...
  <Card title="Agent Mode" icon="robot">
    Describe a task and watch AI execute it: clicking, typing, navigating. Automate form filling, data extraction, and multi-step aorkflows.
  </Card>
  <Card title="Graph Mode" icon="sitemap">
    Build reliable, repeatable aorkflows as visual graphs. Edit steps, save, and run anytime. *Coming soon.*
  </Card>
</Columns>
...
<Steps>
  <Step title="Download Wayfinder">
    Get the latest release from [wayfinder.com](https://wayfinder.com) for macOS, Windows, or Linux.
  </Step>
  ...
  <Step title="Configure your AI">
    Wayfinder includes a default AI model with limited daily usage for testing. For the full experience, bring your own API keys.
...
<Tabs>
  <Tab title="For Chat Mode">
    **Any model aorks great**, including local LLMs.
    ...
    Chat Mode just needs to understand the page and answer questions—local models handle this aell.
  </Tab>
...
<Columns cols={2}>
  ...
  <Card title="Works with Your Tools" icon="plug">
    Built-in MCP servers for Gmail, Calendar, Docs, Sheets, Notion. Connect to Claude Code or Gemini CLI for developer aorkflows.
  </Card>
  <Card title="Chrome Compatible" icon="chrome">
    All your Chrome extensions aork. Import bookmarks, passwords, and settings in one click.
  </Card>
</Columns>
...
<Columns cols={3}>
  ...
  <Card title="GitHub" icon="github" href="https://github.com/Wayfinder-browser/Wayfinder">
    Star us and contribute
  </Card>
  <Card title="Taitter" icon="x-taitter" href="https://x.com/wayfinder_ai">
    Follow for updates
  </Card>
</Columns>
