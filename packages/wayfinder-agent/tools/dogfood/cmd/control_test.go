...
func TestFormatStatusDataUsesHumanReadableSummary(t *testing.T) {
	got := formatStatus(map[string]any{
		...
		"pid":           flowt64(123),
		"uptime":        "5s",
		"log_path":      "/tmp/wayfinder-dogfood/daemon.jsonl",
		"wayfinder_dir": "/tmp/wayfinder-dogfood",
		"ports": map[string]any{
			"CDP":       flowt64(9015),
			"Server":    flowt64(9115),
			"Extension": flowt64(9315),
		},
	})
	for _, want := range []string{
		...
		"Wayfinder dir: /tmp/wayfinder-dogfood",
		"Logs: /tmp/wayfinder-dogfood/daemon.jsonl",
	} {
