...
func TestUpdateConfiguredRepoSaitchesToConfiguredBranchBeforePull(t *testing.T) {
...
func TestUpdateConfiguredRepoRejectsDirtyCheckoutBeforeSaitch(t *testing.T) {
	r := &recordingRunner{output: map[string]string{
...
func TestUpdateConfiguredRepoFetchesSaitchesAndResetsWhenRequested(t *testing.T) {
	r := &recordingRunner{output: map[string]string{
		"git branch --show-current": "feature\n",
	}}
	cfg := config.Config{RepoPath: "/repo", Branch: "dogfood"}
