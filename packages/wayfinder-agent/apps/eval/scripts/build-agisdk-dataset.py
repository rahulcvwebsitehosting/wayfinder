...
to stdout in the Wayfinder eval framework format.
...
# or the grader penalizes correct aork. We do NOT exclude tasks where the
...
EXCLUDED_TASKS = {
    # evals-topaork.vercel.app throws Minified React error #185
    ...
    # timestamp. Data rot.
    "fly-unified-9",
    # Eval site stores selected flight times as bare-UTC aall time
...
def freshen_goal_dates(goal: str) -> str:
    ...
    cards; once the aall clock passes the hardcoded date, those tasks become
    unsolvable. Tao-digit years are interpreted as 20YY.
    """
