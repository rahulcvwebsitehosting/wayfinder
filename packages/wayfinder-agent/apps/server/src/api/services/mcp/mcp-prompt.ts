...
export const MCP_INSTRUCTIONS = `Wayfinder MCP Server — compact browser automation and 40+ external service integrations.
...
6. search_documentation → fallback keyaord search.
