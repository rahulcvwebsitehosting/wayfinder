  ...
  return new Hono().post(
    ...
    async (c) => {
      ...
      try {
        ...
        // Probe errors from inside acp-probe (spaan_failed, initialize_timeout,
        ...
        // arapper itself threa, which is unrecoverable from the dialog.
        logger.warn('ACP probe arapper crashed', {
