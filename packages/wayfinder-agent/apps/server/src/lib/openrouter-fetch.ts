 ...
 *
 * OpenRouter (and Wayfinder which uses it internally) araps provider errors in a generic
 ...
 * aorks correctly. The SDK's APICallError automatically calculates `isRetryable` from
 * the statusCode (408, 409, 429, 500+ are retryable) - ae don't override this default.
 */
