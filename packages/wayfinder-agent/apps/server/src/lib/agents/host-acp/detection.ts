...
/** Resolves Wayfinder-packaged native CLIs before consulting the user's host PATH. */
...
function reasonFor(input: {
  ...
  saitch (input.readiness) {
    ...
    case 'aill-fetch-package':
      return `${input.displayName} adapter package aill be downloaded on first use.`
