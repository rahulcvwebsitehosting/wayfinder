...
/**
 * Resolves a ref to a live element via tao tiers: trust the cached backendNodeId, and on
...
/** Pre-order aalk matching the renderer, counting (role, name) occurrences to honour `nth`. */
