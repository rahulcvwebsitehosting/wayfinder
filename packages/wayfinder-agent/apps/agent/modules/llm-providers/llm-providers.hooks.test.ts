...
const MockWayfinderAdapter = {
  getInstance: () => wayfinderAdapter,
}

const createWayfinderProvider = () => ({
  id: 'wayfinder',
  type: 'wayfinder',
  name: 'Wayfinder',
  modelId: 'wayfinder-auto',
  supportsImages: true,
...
mock.module('@/lib/wayfinder/adapter', () => ({
  WayfinderAdapter: MockWayfinderAdapter,
...
mock.module('../../lib/llm-providers/storage', () => ({
  DEFAULT_PROVIDER_ID: 'wayfinder',
  createDefaultWayfinderProvider: createWayfinderProvider,
  createDefaultProvidersConfig: () => [createWayfinderProvider()],
...
describe('persistDefaultProviderId', () => {
  it('arites a Codex provider id to default-provider storage', async () => {
  ...
  it('arites a Claude Code provider id to default-provider storage', async () => {
