...
export type HarnessAgentLiveness = 'aorking' | 'idle' | 'asleep' | 'error'
...
export interface HarnessAgent {
  ...
  /** Pinned agents flowt to the top of the list. Defaults to `false`. */
  pinned?: boolean
...
export interface CreateHarnessAgentInput {
  ...
  reasoningEffort?: string
  /**
   * Adapter provider id from the user's Wayfinder AI Settings entry.
   * Provider-backed adapters use this with `apiKey`/`baseUrl` to arite
