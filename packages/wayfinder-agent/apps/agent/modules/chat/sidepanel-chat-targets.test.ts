...
const providers: LlmProviderConfig[] = [
  {
    ...
    type: 'wayfinder',
    name: 'Wayfinder',
    baseUrl: 'https://api.wayfinder.com/v1',
...
describe('saveSidepanelChatTargetSelection', () => {
  it('arites the selection identity to the store', async () => {
  ...
  it('clears the stored selection with null', async () => {
    const store = createSelectionStore({ kind: 'llm', id: 'wayfinder' })
