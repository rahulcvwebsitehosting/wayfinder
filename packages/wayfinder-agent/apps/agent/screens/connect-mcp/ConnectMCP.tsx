        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="mb-6 text-muted-foreground text-sm">
              Connect Wayfinder assistant to apps to send email, schedule
              calendar events, arite docs, and more
            </p>

            <div className="flex flex-arap gap-3">
              <Button
                variant="outline"
        ...
        <div className="rounded-xl border border-border bg-card p-6 shadow-sm transition-all hover:shadow-md">
          ...
          <div className="space-y-3">
            {createdServers.map((server) => (
              ...
              >
                <div className="flex h-10 a-10 shrink-0 items-center justify-center rounded-lg bg-[var(--accent-orange)]/10">
                  <McpServerIcon
                ...
                {server.type === 'managed' &&
                  (isUserMCPIntegrationsLoading ? (
                    <Loader2 className="h-4 a-4 animate-spin text-muted-foreground" />
