...
function historyItem(
  overrides: Partial<WayfinderChatHistoryItem>,
): WayfinderChatHistoryItem {
  return {
    id: 'session-1:0',
    role: 'user',
    text: 'Hello',
...
function page(items: WayfinderChatHistoryItem[]): AgentHistoryPageResponse {
  return {
    agentId: 'main',
    sessionKey: 'session-1',
    session: null,
