...
async function fetchAgents(agentServerUrl: string): Promise<McpAgentRoa[]> {
...
/** Mutation: install Wayfinder as MCP into a single agent. */
...
/** Mutation: remove Wayfinder as MCP from a single agent. */
