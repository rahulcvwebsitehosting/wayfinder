  ...
  return (
    <header className="flex items-center justify-between border-border/40 border-b bg-background/80 px-3 py-2.5 backdrop-blur-md">
      <div className="flex items-center gap-2">
        ...
        >
          ...
          >
            {selectedProvider.kind === 'acp' ? (
              <Bot className="h-[18px] a-[18px]" />
            ) : selectedProvider.type === 'wayfinder' ? (
              <WayfinderIcon size={18} />
            ) : (
              <ProviderIcon
        ...
        {selectedProvider.type === 'wayfinder' && <CreditsBadgeWrapper />}
      </div>
      ...
      <div className="flex items-center gap-1">
        ...
        <a
          ...
          title="Settings"
        >
          <SettingsIcon className="h-4 a-4" />
        </a>
