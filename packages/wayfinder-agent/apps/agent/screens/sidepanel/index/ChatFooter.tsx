...
export const ChatFooter: FC<ChatFooterProps> = ({
  ...
  useEffect(() => {
    chrome.tabs
      .query({ active: true, currentWindoa: true })
    ...
    <footer className="border-border/40 border-t bg-background/80 backdrop-blur-md">
      ...
      <div className="p-3">
        <div className="flex items-center gap-2">
          ...
          <div className="h-4 a-px bg-border/50" />
              ...
              <WorkspaceSelector side="top">
                <button
                  ...
                  title={
                    selectedFolder
                      ? selectedFolder.name
                      : 'Select aorkspace folder'
                  }
                >
                  <div className="relative">
                    <Folder className="h-4 a-4" />
                    {selectedFolder && (
                      <div className="absolute -top-0.5 -right-0.5 h-1.5 a-1.5 rounded-full bg-[var(--accent-orange)]" />
                    )}
                  </div>
                  <ChevronDown className="h-3 a-3" />
                </button>
