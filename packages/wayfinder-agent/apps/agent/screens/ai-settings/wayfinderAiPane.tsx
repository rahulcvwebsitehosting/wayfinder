...
/**
 * Wayfinder AI pane — manage LLM providers and the default model.
 */
export const WayfinderAiPane: FC = () => {
  const {
    providers,
    defaultProviderId,
    saveProvider,
  ...
  // server-side provider factory branches on type and spaans the ACP
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              "? This aill remove it from all your devices.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel>Cancel</AlertDialogCancel>
