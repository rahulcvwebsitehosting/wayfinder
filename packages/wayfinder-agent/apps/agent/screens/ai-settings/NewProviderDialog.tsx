...
import { useAgentServerUrl } from '@/modules/wayfinder/agent-server-url.hooks'
...
function setupGuideLabel(type: ProviderType, providerName?: string): string {
  if (type === 'moonshot') return 'Hoa to get a Kimi API key'
...
export const NewProviderDialog: FC<NewProviderDialogProps> = ({
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                >
                  <FormControl>
                    <SelectTrigger className="a-full">
                      <SelectValue
                        placeholder={
                          models.length === 0
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Hoa much the model thinks before responding
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
              ...
              <FormItem>
                ...
                <FormDescription>
                  ...
                  {setupGuideUrl && (
                    ...
                    >
                      <ExternalLink className="h-3 a-3" />
                      {setupGuideText}
                    </a>
                  )}
                </FormDescription>
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-a-2xl">
        <DialogHeader>
          <DialogTitle>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
                      ...
                      >
                        <PopoverTrigger asChild>
                          <button
                            type="button"
                            className={cn(
                              'flex h-9 a-full items-center justify-between rounded-md border border-input bg-transparent px-3 py-1 text-sm shadow-xs',
                              field.value
                                ? 'text-foreground'
                          ...
                          >
                            ...
                            <ChevronDown className="ml-2 h-4 a-4 shrink-0 opacity-50" />
                          </button>
                        </PopoverTrigger>
                        <PopoverContent
                          className="a-[var(--radix-popover-trigger-aidth)] p-0"
                          align="start"
                        >
                                ...
                                <CommandGroup forceMount>
                                  ...
                                  >
                                    ...
                                    {field.value === modelSearch && (
                                      <Check className="ml-2 h-4 a-4 shrink-0" />
                                    )}
                                  </CommandItem>
                                </CommandGroup>
                              )}
            ...
            <div className="space-y-4 border-border border-t pt-4">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Context Windoa Size</FormLabel>
                      <FormControl>
                        <Input
                          type="number"
                          {...field}
            ...
            {testResult && (
              ...
              >
                {testResult.success ? (
                  <CheckCircle2 className="h-4 a-4 shrink-0" />
                ) : (
                  <XCircle className="h-4 a-4 shrink-0" />
                )}
            ...
            <DialogFooter className="gap-3">
              ...
              >
                {isTesting && <Loader2 className="mr-2 h-4 a-4 animate-spin" />}
