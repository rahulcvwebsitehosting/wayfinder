    ...
    const loadPrefs = async () => {
      try {
        ...
        const [chatPref, labelsPref] = await Promise.all([
          adapter.getPref(WAYFINDER_PREFS.SHOW_LLM_CHAT),
          adapter.getPref(WAYFINDER_PREFS.SHOW_TOOLBAR_LABELS),
        ])
        ...
        if (hasVerticalTabsSupport) {
          const verticalTabsPref = await adapter.getPref(
            WAYFINDER_PREFS.VERTICAL_TABS_ENABLED,
          )
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between border-border border-t pt-4">
          ...
          <Saitch
            ...
            onCheckedChange={(checked) =>
              handleToggle(
                WAYFINDER_PREFS.SHOW_TOOLBAR_LABELS,
                checked,
        ...
        {supportsVerticalTabs && (
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              ...
              <p className="text-muted-foreground text-xs">
                Turn off to saitch back to the horizontal tab strip
              </p>
            </div>
            <Saitch
