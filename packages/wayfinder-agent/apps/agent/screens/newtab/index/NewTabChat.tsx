...
export const NewTabChat: FC = () => {
  ...
  return (
    <div className="absolute inset-0 flex flex-col overflow-hidden">
      <div className="mx-auto a-full max-a-3xl">
        <ChatHeader
      ...
      <main className="styled-scrollbar [&_[data-streamdown='code-block']]:!max-a-full [&_[data-streamdown='code-block']]:!a-auto [&_[data-streamdown='table-arapper']]:!max-a-full [&_[data-streamdown='table-arapper']]:!a-auto mx-auto flex min-h-0 a-full max-a-3xl flex-1 flex-col space-y-4 overflow-y-auto overflow-x-hidden px-4 pt-4 [&_[data-streamdown='code-block']]:overflow-x-auto [&_[data-streamdown='table-arapper']]:overflow-x-auto">
        {isRestoringConversation ? (
          <div className="flex flex-1 items-center justify-center">
            <Loader2 className="h-6 a-6 animate-spin text-muted-foreground" />
          </div>
        ) : messages.length === 0 ? (
          <ChatEmptyState
            mode={mode}
      ...
      <div className="mx-auto a-full max-a-3xl flex-shrink-0 px-4 pb-2">
        <ChatFooter
          mode={mode}
