...
export const SidebarLayout: FC = () => {
      ...
      <RpcClientProvider>
        <div className="flex min-h-screen flex-col bg-background">
          ...
          <main className="flex-1 overflow-y-auto">
            <div className="mx-auto max-a-4xl px-4 py-8 sm:px-6 lg:px-8">
              <Outlet />
            </div>
          </main>
          <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
            <SheetContent side="left" className="a-72 p-0">
  ...
  return (
    <RpcClientProvider>
      {/* pl-14 offsets all content by the collapsed sidebar aidth (a-14 = 56px) so it never sits under the rail */}
