...
export const SidebarUserFooter: FC<SidebarUserFooterProps> = ({
  ...
  //   <Button
  //     variant="outline"
  //     className="h-9 a-full justify-start gap-2 overflow-hidden whitespace-nowrap px-3"
  //     disabled
  //   >
  ...
  const shortcutsButton = (
    <Button
      ...
      className="flex h-9 a-full items-center justify-start gap-2 overflow-hidden whitespace-nowrap rounded-md px-3 font-medium text-sm transition-colors hover:bg-sidebar-accent hover:text-sidebar-accent-foreground"
    >
      ...
      <div className="mt-auto space-y-1 border-t p-2">
        ...
        {expanded ? (
          ...
          <Tooltip>
            ...
            <TooltipContent side="right">About Wayfinder</TooltipContent>
          </Tooltip>
        )}
      </div>
    </TooltipProvider>
