...
import { Capabilities } from '@/lib/wayfinder/capabilities'
import { getHealthCheckUrl, getMcpServerUrl } from '@/lib/wayfinder/helpers'
import { openSidePanel, toggleSidePanel } from '@/lib/wayfinder/toggleSidePanel'
import { checkAndShowChangelog } from '@/lib/changelog/changelog-notifier'
import {
  setupLlmProvidersBackupToWayfinder,
