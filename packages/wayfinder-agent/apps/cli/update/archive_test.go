...
func TestExtractBinaryTarGz(t *testing.T) {
	archive := createTarGz(t, map[string]string{"wayfinder-cli": "new-binary"})
...
func TestExtractBinaryZip(t *testing.T) {
	archive := createZip(t, map[string]string{"wayfinder-cli.exe": "new-binary"})
...
func TestExtractBinaryTarGzRejectsMultipleFiles(t *testing.T) {
	archive := createTarGz(t, map[string]string{
		"wayfinder-cli":     "new-binary",
		"wayfinder-cli.sig": "signature",
	})
...
func TestApplyBinary(t *testing.T) {
	targetPath := filepath.Join(t.TempDir(), "wayfinder-cli")
...
func TestVerifyThenApplyIntegration(t *testing.T) {
	archive := createTarGz(t, map[string]string{"wayfinder-cli": "updated-binary"})
