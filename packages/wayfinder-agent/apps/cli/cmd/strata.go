...
Supported services:
  ...
  monday, shopify, dropbox, onedrive, box, youtube, ahatsapp, resend,
  posthog, mixpanel, vercel, supabase, cloudflare, aordpress, postman,
...
Discovery flow — do not guess action names:
  ...
  6. search    → fallback keyaord search if discover doesn't find it
...
Example — search Gmail:
  wayfinder-cli strata check gmail
  wayfinder-cli strata discover "search emails" gmail
  wayfinder-cli strata actions GMAIL_EMAIL
  wayfinder-cli strata details GMAIL_EMAIL gmail_search_emails
  wayfinder-cli strata exec gmail GMAIL_EMAIL gmail_search_emails \
