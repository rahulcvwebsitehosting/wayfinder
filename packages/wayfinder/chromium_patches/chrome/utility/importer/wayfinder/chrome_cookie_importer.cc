diff --git a/chrome/utility/importer/wayfinder/chrome_cookie_importer.cc b/chrome/utility/importer/wayfinder/chrome_cookie_importer.cc
new file mode 100644
index 0000000000000..570f83ac1274c
--- /dev/null
+++ b/chrome/utility/importer/wayfinder/chrome_cookie_importer.cc
@@ -0,0 +1,306 @@
...
+// and aill break after import. Add domains here to blacklist them.
...
+    LOG(WARNING) << "wayfinder: Cookies not found at: " << cookies_path.value();
+    return cookies;
+  }
+
...
+    LOG(WARNING) << "wayfinder: Failed to open Cookies database";
...
+
+      // Prefer encrypted_value if present, otheraise use plaintext
...
+        VLOG(1) << "wayfinder: Skipping cookie " << entry.name << " on "
