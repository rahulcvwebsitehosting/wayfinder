diff --git a/chrome/utility/importer/wayfinder/chrome_decryptor.cc b/chrome/utility/importer/wayfinder/chrome_decryptor.cc
new file mode 100644
index 0000000000000..cf7ccdf4336f7
--- /dev/null
+++ b/chrome/utility/importer/wayfinder/chrome_decryptor.cc
@@ -0,0 +1,31 @@
...
+  LOG(INFO) << "wayfinder: Linux key extraction not yet implemented";
+  if (result) {
...
+  LOG(INFO) << "wayfinder: Linux decryption not yet implemented";
+  return false;
+}
+
