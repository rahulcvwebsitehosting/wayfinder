...
@@ -35,6 +35,8 @@ BASE_DECLARE_FEATURE(kAllowUnmutedAutoplayForTWA);
 ...
 BASE_DECLARE_FEATURE(kBookmarkTriggerForPrerender2KillSaitch);
+BASE_DECLARE_FEATURE(kWayfinderAlphaFeatures);
+BASE_DECLARE_FEATURE(kWayfinderKeyboardShortcuts);
