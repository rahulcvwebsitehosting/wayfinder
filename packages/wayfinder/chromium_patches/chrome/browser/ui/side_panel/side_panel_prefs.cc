...
+    "wayfinder.third_party_llm.providers";
+constexpr char kThirdPartyLlmSelectedProviderPref[] =
+    "wayfinder.third_party_llm.selected_provider";
+constexpr char kClashOfGptsPaneProvidersPref[] =
+    "wayfinder.clash_of_gpts.pane_providers";
+constexpr char kClashOfGptsLastUrlsPref[] =
+    "wayfinder.clash_of_gpts.last_urls";
+constexpr char kClashOfGptsPaneCountPref[] =
+    "wayfinder.clash_of_gpts.pane_count";
