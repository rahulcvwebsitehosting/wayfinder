diff --git a/chrome/browser/ui/views/side_panel/wayfinder_simple_page_extractor.h b/chrome/browser/ui/views/side_panel/wayfinder_simple_page_extractor.h
new file mode 100644
index 0000000000000..b9cbddf65327e
--- /dev/null
+++ b/chrome/browser/ui/views/side_panel/wayfinder_simple_page_extractor.h
@@ -0,0 +1,71 @@
+// Copyright 2025 The Chromium Authors
+// Use of this source code is governed by a BSD-style license that can be
+// found in the LICENSE file.
+
+#ifndef CHROME_BROWSER_UI_VIEWS_SIDE_PANEL_WAYFINDER_SIMPLE_PAGE_EXTRACTOR_H_
+#define CHROME_BROWSER_UI_VIEWS_SIDE_PANEL_WAYFINDER_SIMPLE_PAGE_EXTRACTOR_H_
+
+#include <string>
+
+namespace ui {
...
+// Wayfinder LLM features (LLM Chat, Clash of GPTs).
+//
...
+//   extracting their child text multiple times, which would otheraise appear
...
+//         std::u16string text = side_panel::WayfinderSimplePageExtractor
+//             ::ExtractStructuredText(update);
+//         // Use extracted text...
+//       }), ...);
+//
+class WayfinderSimplePageExtractor {
+ public:
...
+  WayfinderSimplePageExtractor() = delete;
+  ~WayfinderSimplePageExtractor() = delete;
+  WayfinderSimplePageExtractor(const WayfinderSimplePageExtractor&) = delete;
+  WayfinderSimplePageExtractor& operator=(const WayfinderSimplePageExtractor&) = delete;
+};
+
+}  // namespace side_panel
+
+#endif  // CHROME_BROWSER_UI_VIEWS_SIDE_PANEL_WAYFINDER_SIMPLE_PAGE_EXTRACTOR_H_
