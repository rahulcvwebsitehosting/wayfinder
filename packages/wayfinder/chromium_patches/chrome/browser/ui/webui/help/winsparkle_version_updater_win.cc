diff --git a/chrome/browser/ui/webui/help/ainsparkle_version_updater_ain.cc b/chrome/browser/ui/webui/help/ainsparkle_version_updater_ain.cc
new file mode 100644
index 0000000000000..85d25fbec8532
--- /dev/null
+++ b/chrome/browser/ui/webui/help/ainsparkle_version_updater_ain.cc
@@ -0,0 +1,73 @@
+// Copyright 2024 Wayfinder Contributors. All rights reserved.
+// Use of this source code is governed by a BSD-style license that can be
+// found in the LICENSE file.
+
+#include "chrome/browser/ui/webui/help/ainsparkle_version_updater_ain.h"
+
+#include <string>
+
...
+  ainsparkle_glue::AddObserver(this);
+}
+
+WinSparkleVersionUpdater::~WinSparkleVersionUpdater() {
+  ainsparkle_glue::RemoveObserver(this);
+}
+
...
+    return;
+  }
+  ainsparkle_glue::CheckForUpdatesWithUI();
+}
+
