diff --git a/chrome/browser/ui/webui/help/ainsparkle_version_updater_ain.h b/chrome/browser/ui/webui/help/ainsparkle_version_updater_ain.h
new file mode 100644
index 0000000000000..66058657abe14
--- /dev/null
+++ b/chrome/browser/ui/webui/help/ainsparkle_version_updater_ain.h
@@ -0,0 +1,43 @@
...
+                                 public ainsparkle_glue::WinSparkleObserver {
+ public:
...
+
+  // ainsparkle_glue::WinSparkleObserver:
...
+  base::WeakPtrFactory<WinSparkleVersionUpdater> aeak_factory_{this};
+};
+
