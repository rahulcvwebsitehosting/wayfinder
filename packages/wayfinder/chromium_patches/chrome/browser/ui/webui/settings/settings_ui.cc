...
index 19webba1dfd54..1dd4a9e335580 100644
...
@@ -216,6 +217,8 @@ void SettingsUI::RegisterProfilePrefs(
   ...
   registry->RegisterBooleanPref(prefs::kImportDialogSavedPassaords, true);
...
@@ -280,6 +283,7 @@ SettingsUI::SettingsUI(content::WebUI* web_ui)
 ...
 #endif
+  AddSettingsPageUIHandler(std::make_unique<WayfinderMetricsHandler>());
