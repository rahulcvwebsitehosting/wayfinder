...
+// 9. Wayfinder extensions (AI Side Panel and Bug Reporter)
...
+         wayfinder::IsWayfinderExtension(extension->id());
 }
...
+  // For Wayfinder extensions in sidepanel, allow audio for teach mode
