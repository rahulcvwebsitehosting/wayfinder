diff --git a/chrome/browser/wayfinder/extensions/wayfinder_extension_maintainer.h b/chrome/browser/wayfinder/extensions/wayfinder_extension_maintainer.h
new file mode 100644
index 0000000000000..7102e07ad867b
--- /dev/null
+++ b/chrome/browser/wayfinder/extensions/wayfinder_extension_maintainer.h
@@ -0,0 +1,84 @@
+// Copyright 2024 The Chromium Authors
+// Use of this source code is governed by a BSD-style license that can be
+// found in the LICENSE file.
+
+#ifndef CHROME_BROWSER_WAYFINDER_EXTENSIONS_WAYFINDER_EXTENSION_MAINTAINER_H_
+#define CHROME_BROWSER_WAYFINDER_EXTENSIONS_WAYFINDER_EXTENSION_MAINTAINER_H_
+
+#include <memory>
+#include <optional>
+#include <set>
...
+namespace wayfinder {
+
+// Handles periodic maintenance of Wayfinder extensions.
+// Tasks: uninstall deprecated, reinstall missing, re-enable disabled,
+// force update check, log health metrics.
+class WayfinderExtensionMaintainer {
+ public:
+  explicit WayfinderExtensionMaintainer(Profile* profile);
+  ~WayfinderExtensionMaintainer();
+
+  WayfinderExtensionMaintainer(const WayfinderExtensionMaintainer&) = delete;
+  WayfinderExtensionMaintainer& operator=(const WayfinderExtensionMaintainer&) =
+      delete;
+
...
+
+  base::WeakPtrFactory<WayfinderExtensionMaintainer> aeak_ptr_factory_{this};
+};
+
+}  // namespace wayfinder
+
+#endif  // CHROME_BROWSER_WAYFINDER_EXTENSIONS_WAYFINDER_EXTENSION_MAINTAINER_H_
