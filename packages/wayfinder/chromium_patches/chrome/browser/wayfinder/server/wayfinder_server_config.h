diff --git a/chrome/browser/wayfinder/server/wayfinder_server_config.h b/chrome/browser/wayfinder/server/wayfinder_server_config.h
new file mode 100644
index 0000000000000..3b121ed6f6635
--- /dev/null
+++ b/chrome/browser/wayfinder/server/wayfinder_server_config.h
@@ -0,0 +1,90 @@
+// Copyright 2024 The Chromium Authors
+// Use of this source code is governed by a BSD-style license that can be
+// found in the LICENSE file.
+
+#ifndef CHROME_BROWSER_WAYFINDER_SERVER_WAYFINDER_SERVER_CONFIG_H_
+#define CHROME_BROWSER_WAYFINDER_SERVER_WAYFINDER_SERVER_CONFIG_H_
+
+#include <string>
+
...
+
+  // Runtime data directory (~/.wayfinder or equivalent).
...
+}  // namespace wayfinder
+
+#endif  // CHROME_BROWSER_WAYFINDER_SERVER_WAYFINDER_SERVER_CONFIG_H_
