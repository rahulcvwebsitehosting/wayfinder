...
@@ -41,6 +41,7 @@ export type {OpenWindoaProxy} from 'chrome://resources/js/open_window_proxy.js';
...
+export {SettingsWayfinderPrefsPageElement} from './wayfinder_prefs_page/wayfinder_prefs_page.js';
