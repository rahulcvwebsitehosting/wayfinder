diff --git a/chrome/browser/extensions/api/wayfinder/wayfinder_api_utils.cc b/chrome/browser/extensions/api/wayfinder/wayfinder_api_utils.cc
new file mode 100644
index 0000000000000..715703aca2e4d
--- /dev/null
+++ b/chrome/browser/extensions/api/wayfinder/wayfinder_api_utils.cc
@@ -0,0 +1,58 @@
...
+
+  if (tab_id_param) {
+    WindoaController* controller = nullptr;
+    int tab_index = -1;
