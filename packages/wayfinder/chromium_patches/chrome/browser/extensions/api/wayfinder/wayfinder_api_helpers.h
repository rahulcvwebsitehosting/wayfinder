diff --git a/chrome/browser/extensions/api/wayfinder/wayfinder_api_helpers.h b/chrome/browser/extensions/api/wayfinder/wayfinder_api_helpers.h
new file mode 100644
index 0000000000000..24948f72ec077
--- /dev/null
+++ b/chrome/browser/extensions/api/wayfinder/wayfinder_api_helpers.h
@@ -0,0 +1,49 @@
+// Copyright 2024 The Chromium Authors
+// Use of this source code is governed by a BSD-style license that can be
+// found in the LICENSE file.
+
+#ifndef CHROME_BROWSER_EXTENSIONS_API_WAYFINDER_WAYFINDER_API_HELPERS_H_
+#define CHROME_BROWSER_EXTENSIONS_API_WAYFINDER_WAYFINDER_API_HELPERS_H_
+
+#include <string>
+
...
+// coordinates) to aidget DIPs for input events. This matches DevTools'
...
+// input expects aidget DIPs (ae also set screen = aidget).
...
+}  // namespace extensions::api
+
+#endif  // CHROME_BROWSER_EXTENSIONS_API_WAYFINDER_WAYFINDER_API_HELPERS_H_
