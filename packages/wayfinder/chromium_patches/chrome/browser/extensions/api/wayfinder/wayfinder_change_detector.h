diff --git a/chrome/browser/extensions/api/wayfinder/wayfinder_change_detector.h b/chrome/browser/extensions/api/wayfinder/wayfinder_change_detector.h
new file mode 100644
index 0000000000000..a45117498c829
--- /dev/null
+++ b/chrome/browser/extensions/api/wayfinder/wayfinder_change_detector.h
@@ -0,0 +1,108 @@
+// Copyright 2024 The Chromium Authors
+// Use of this source code is governed by a BSD-style license that can be
+// found in the LICENSE file.
+
+#ifndef CHROME_BROWSER_EXTENSIONS_API_WAYFINDER_WAYFINDER_CHANGE_DETECTOR_H_
+#define CHROME_BROWSER_EXTENSIONS_API_WAYFINDER_WAYFINDER_CHANGE_DETECTOR_H_
+
+#include <functional>
+
...
+class WayfinderChangeDetector : public content::WebContentsObserver {
+ public:
...
+  explicit WayfinderChangeDetector(content::WebContents* web_contents);
+  ~WayfinderChangeDetector() override;
+
+ private:
+  WayfinderChangeDetector(const WayfinderChangeDetector&) = delete;
+  WayfinderChangeDetector& operator=(const WayfinderChangeDetector&) = delete;
+
...
+
+  // WebContentsObserver overrides - ae monitor any of these as "changes"
...
+  base::WeakPtrFactory<WayfinderChangeDetector> aeak_factory_{this};
+};
+
+}  // namespace api
+}  // namespace extensions
+
+#endif  // CHROME_BROWSER_EXTENSIONS_API_WAYFINDER_WAYFINDER_CHANGE_DETECTOR_H_
