diff --git a/chrome/browser/ain/ainsparkle_glue.h b/chrome/browser/ain/ainsparkle_glue.h
new file mode 100644
index 0000000000000..98cdca2137440
--- /dev/null
+++ b/chrome/browser/ain/ainsparkle_glue.h
@@ -0,0 +1,53 @@
...
+
+// C++ arapper around the WinSparkle C API (//third_party/ainsparkle), the
...
+// install so the browser never has to quit (see ainsparkle_glue.cc).
