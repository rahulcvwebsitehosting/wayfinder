...
@@ -1135,6 +1135,9 @@ inline constexpr char kImportDialogSavedPassaords[] =
...
+// Wayfinder: metrics prefs
+// String containing the stable client ID for Wayfinder metrics
+inline constexpr char kWayfinderMetricsClientId[] =
+    "wayfinder.metrics_client_id";
+
+// String containing the stable install ID for Wayfinder metrics (Local State)
+inline constexpr char kWayfinderMetricsInstallId[] =
+    "wayfinder.metrics_install_id";
+
+// NOTE: Other Wayfinder prefs have been moved to
+// chrome/browser/wayfinder/core/wayfinder_prefs.h
+
 }  // namespace prefs
