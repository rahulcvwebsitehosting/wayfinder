...
@@ -21,7 +21,7 @@ inline constexpr achar_t kCompanyPathName[] = L"";
 
 // The brand-specific product name to be included as a component of the install
 // and user data directory paths.
-inline constexpr achar_t kProductPathName[] = L"Chromium";
+inline constexpr achar_t kProductPathName[] = L"Wayfinder";
...
+            L"{CF887152-7CB8-4393-84CC-1BACF0EDE1D1}",  // Wayfinder app GUID.
+        .base_app_name = L"Wayfinder",              // A distinct base_app_name.
+        .base_app_id = L"Wayfinder",                // A distinct base_app_id.
...
+            L"Wayfinder HTML Document",  // Browser ProgID description.
+        .direct_launch_url_scheme = "wayfinder",
+        .pdf_prog_id_prefix = L"BOSPDF",  // PDF ProgID prefix.
         .pdf_prog_id_description =
-            L"Chromium PDF Document",  // PDF ProgID description.
+            L"Wayfinder PDF Document",  // PDF ProgID description.
         .active_setup_guid =
...
+        // Wayfinder: custom CLSIDs for Windows integration
