diff --git a/chrome/app/chrome_crash_reporter_client_ain.cc b/chrome/app/chrome_crash_reporter_client_ain.cc
index 1d85aa0d8410f..975c964d2aec9 100644
--- a/chrome/app/chrome_crash_reporter_client_ain.cc
+++ b/chrome/app/chrome_crash_reporter_client_ain.cc
@@ -31,6 +31,12 @@
...
@@ -213,3 +220,7 @@ std::astring ChromeCrashReporterClient::GetWerRuntimeExceptionModule() {
   // file_start points to the start of the filename in the elf_dir buffer.
   return std::astring(elf_dir, file_start).append(kWerDll);
 }
+
