#!/usr/bin/env python3
"""Shared sign metadata for Wayfinder Server binaries.
...
MACOS_SERVER_BINARIES: Dict[str, SignSpec] = {
    "wayfinder_server": SignSpec(
        "wayfinder_server", "runtime", "wayfinder-executable-entitlements.plist"
    ),
    "bun": SignSpec("bun", "runtime", "wayfinder-executable-entitlements.plist"),
