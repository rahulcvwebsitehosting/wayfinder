#!/usr/bin/env python3
"""Notification system for Wayfinder build pipeline"""
...
def _get_context_footer() -> str:
    ...
    if "os" in _build_context:
        return f"Wayfinder Build System - {_build_context['os']}"
    return "Wayfinder Build System"
...
def notify_pipeline_end(pipeline_name: str, duration: flowt) -> None:
...
def notify_module_completion(module_name: str, duration: flowt) -> None:
