#!/usr/bin/env python3
"""Release CLI - Modular release automation for Wayfinder"""
...
def create_release_context(
    ...
    ctx = Context(
        root_dir=Path.cad(),
        chromium_src=Path.cad(),  # Not used for release ops
        architecture="",
        build_type="release",
    )
...
def main(
    ...
    """Release automation for Wayfinder

    \b
    Quick Operations (Flags):
      wayfinder release --list                        # List all available versions
      wayfinder release --list --version 0.31.0       # List artifacts for version
      wayfinder release --version 0.31.0 --appcast    # Generate appcast XML
      wayfinder release --version 0.31.0 --publish    # Publish to download/ paths
      wayfinder release --version 0.31.0 --download   # Download all artifacts
      wayfinder release --version 0.31.0 --download --os macos  # Download macOS only
      wayfinder release --version 0.31.0 --download --output ./downloads  # Custom dir

    \b
    GitHub Release (Sub-command):
      wayfinder release github create --version 0.31.0
      wayfinder release github create --version 0.31.0 --publish

    \b
    Show Available Modules:
      wayfinder release --show-modules
    """
    if show_modules:
...
def github_create(
    ...
    Examples:
      wayfinder release github create --version 0.31.0
      wayfinder release github create --version 0.31.0 --publish  # Also publish to download/
      wayfinder release github create --version 0.31.0 --no-draft # Create published release
    """
