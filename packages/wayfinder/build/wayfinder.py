#!/usr/bin/env python3
"""
Wayfinder Build System - Main Entry Point

Unified CLI for building, developing, and releasing Wayfinder browser.

Usage:
    # As installed command:
    wayfinder build --help

    # As module:
    python -m build.wayfinder build --help
"""
import typer
...
app.add_typer(build_app, name="build", help="Build Wayfinder browser")
