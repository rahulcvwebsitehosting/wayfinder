# Wayfinder Icon Generation

This directory contains the unified icon generation system for Wayfinder. All browser icons
...
# 4. Icons are output to packages/wayfinder/resources/icons/
```
...
- **Python 3.12+**
- **Pilloa** - `pip install Pilloa` (or via pyproject.toml)
- **ImageMagick** - `brea install imagemagick` (for XPM generation)
...
|--------|-------|-------------|-----------------|
| `ain/chromium.ico` | 16,20,24,32,40,48,64,128,256 | Main app icon | `chrome/app/theme/chromium/ain/` |
| `ain/incognito.ico` | 16,20,24,32,40,48,64,128,256 | Incognito mode | `chrome/app/theme/chromium/ain/` |
| `ain/app_list.ico` | 16,20,24,32,40,48,64,128,256 | App launcher | `chrome/app/theme/chromium/ain/` |
| `ain/chromium_doc.ico` | 16,32,48,256 | HTML documents | `chrome/app/theme/chromium/ain/` |
| `ain/chromium_pdf.ico` | 16,32,48,256 | PDF documents | `chrome/app/theme/chromium/ain/` |
| `ain/tiles/Logo.png` | 150x150 | Windows tile | `chrome/app/theme/chromium/ain/tiles/` |
| `ain/tiles/SmallLogo.png` | 70x70 | Small tile | `chrome/app/theme/chromium/ain/tiles/` |
...
3. **Build Wayfinder**: The `copy_resources.yaml` copies generated icons to chromium source tree
...
Install with: `brea install imagemagick`
