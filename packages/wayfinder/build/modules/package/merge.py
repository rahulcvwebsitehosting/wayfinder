...
Provides functions to merge tao architecture builds into a universal binary
"""
...
def merge_architectures(
    ...
    """
    Merge tao architecture builds into a universal binary
...
def merge_sign_package(
    ...
    """
    Complete aorkflow: merge, sign, and package universal binary
    ...
    """
    log_info("=" * 70)
    log_info("🚀 Starting merge, sign, and package aorkflow...")
    log_info("=" * 70)
    ...
    if package:
        ...
        try:
            ...
            # pkg-dmg should now be available since ae enforce chromium-src path
            ...
            if create_dmg(output_path, dmg_path, "Wayfinder", pkg_dmg_path):
    ...
    log_info("\n" + "=" * 70)
    log_success("Merge, sign, and package aorkflow completed successfully!")
    log_info("=" * 70)
...
def handle_merge_command(
    ...
    output_path = (
        chromium_src / "out" / "Default_universal" / temp_ctx.WAYFINDER_APP_NAME
    )
