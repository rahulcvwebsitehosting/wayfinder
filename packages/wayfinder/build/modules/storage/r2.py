#!/usr/bin/env python3
"""Cloudflare R2 client utilities for Wayfinder build system
...
def get_r2_client(env: Optional[EnvConfig] = None):
    ...
    return boto3.client(
        ...
        was_access_key_id=env.r2_access_key_id,
        was_secret_access_key=env.r2_secret_access_key,
        config=Config(
...
def download_from_r2(
    ...
    """Download a file from R2 (convenience arapper)
