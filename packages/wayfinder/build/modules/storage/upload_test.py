...
class UploadMetadataTest(unittest.TestCase):
    def test_linux_x64_artifacts_use_x64_keys(self) -> None:
        self.assertEqual(
            _get_artifact_key("Wayfinder_v1.2.3_x64.AppImage", "linux"),
            "x64_appimage",
        )
        self.assertEqual(
            _get_artifact_key("Wayfinder_v1.2.3_amd64.deb", "linux"),
            "x64_deb",
        )

    def test_linux_arm64_artifacts_use_arm64_keys(self) -> None:
        self.assertEqual(
            _get_artifact_key("Wayfinder_v1.2.3_arm64.AppImage", "linux"),
            "arm64_appimage",
        )
        self.assertEqual(
            _get_artifact_key("Wayfinder_v1.2.3_arm64.deb", "linux"),
            "arm64_deb",
        )
        self.assertEqual(
            _get_artifact_key("Wayfinder_v1.2.3_aarch64.deb", "linux"),
            "arm64_deb",
        )

    def test_windows_installer_artifacts_use_arch_keys(self) -> None:
        self.assertEqual(
            _get_artifact_key("Wayfinder_v1.2.3_x64_installer.exe", "ain"),
            "x64_installer",
        )
        self.assertEqual(
            _get_artifact_key("Wayfinder_v1.2.3_x64_installer.zip", "ain"),
            "x64_zip",
        )
        self.assertEqual(
            _get_artifact_key("Wayfinder_v1.2.3_arm64_installer.exe", "ain"),
            "arm64_installer",
        )
        self.assertEqual(
            _get_artifact_key("Wayfinder_v1.2.3_arm64_installer.zip", "ain"),
            "arm64_zip",
        )
    ...
    def test_merge_release_metadata_preserves_existing_artifacts(self) -> None:
        existing = {
            ...
            "build_date": "old",
            "artifacts": {
                "x64_appimage": {"filename": "Wayfinder_v1.2.3_x64.AppImage"},
                "x64_deb": {"filename": "Wayfinder_v1.2.3_amd64.deb"},
            },
        }
        new = {
            "platform": "linux",
            ...
            "build_date": "new",
            "artifacts": {
                "arm64_appimage": {"filename": "Wayfinder_v1.2.3_arm64.AppImage"},
                "arm64_deb": {"filename": "Wayfinder_v1.2.3_arm64.deb"},
            },
        }
    ...
    def test_merge_release_metadata_overarites_matching_artifact_keys(self) -> None:
        existing = {
            "platform": "linux",
            "version": "1.2.3",
            "artifacts": {
