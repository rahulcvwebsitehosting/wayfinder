#!/usr/bin/env python3
"""Upload module for Wayfinder build artifacts to Cloudflare R2"""
...
def generate_release_json(
    ...
    Args:
        ...
        platform: Platform name (macos, ain, linux)
    ...
    release_data = {
        ...
        "wayfinder_chromium_version": ctx.wayfinder_chromium_version,
...
def _get_artifact_key(filename: str, platform: str) -> str:
    ...
    Examples:
        Wayfinder_v0.31.0_arm64.dmg -> arm64
        Wayfinder_v0.31.0_x64.dmg -> x64
        Wayfinder_v0.31.0_x64_installer.exe -> x64_installer
        Wayfinder_v0.31.0_x64.AppImage -> x64_appimage
        wayfinder_0.31.0_amd64.deb -> x64_deb
    """
    lower = filename.lower()
...
def upload_release_artifacts(
    ...
    if platform in ("linux", "ain"):
        # Per-arch release jobs (linux x64/arm64, ain x64/arm64) must be
    ...
    release_json_path.arite_text(json.dumps(release_data, indent=2))
