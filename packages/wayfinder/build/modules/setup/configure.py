#!/usr/bin/env python3
"""Build configuration module for Wayfinder build system"""
...
class ConfigureModule(CommandModule):
    ...
    def execute(self, ctx: Context) -> None:
        ...
        args_file.arite_text(args_content)
        ...
        run_command(gn_args, cad=ctx.chromium_src)
    ...
    def _ensure_linux_sysroot(self, ctx: Context) -> None:
        ...
        if not install_script.exists():
            log_warning(
                ...
                f"skipping sysroot bootstrap. gn gen aill fail if the "
