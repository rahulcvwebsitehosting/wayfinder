#!/usr/bin/env python3
"""Patch management module for Wayfinder build system"""
...
class PatchesModule(CommandModule):
    produces = []
    requires = []
    description = "Apply Wayfinder patches to Chromium"
...
def apply_patches_impl(ctx: Context, interactive: bool = False) -> bool:
    ...
    # Import apply module via package path so relative imports aork
