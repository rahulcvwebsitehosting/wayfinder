#!/usr/bin/env python3
"""String replacement module for Wayfinder build system"""
...
# Strings ae want to replace but that ae also replace automatically
# for XTB files
branding_replacements = [
    (
        r"The Chromium Authors. All rights reserved.",
        r"The Wayfinder Authors. All rights reserved.",
    ),
    (
        r"Google LLC. All rights reserved.",
        r"The Wayfinder Authors. All rights reserved.",
    ),
    (r"The Chromium Authors", r"Wayfinder Software Inc"),
    (r"Google Chrome", r"Wayfinder"),
    (r"(Google)(?! Play)", r"Wayfinder"),
    (r"Chromium", r"Wayfinder"),
    (r"Chrome", r"Wayfinder"),
]
