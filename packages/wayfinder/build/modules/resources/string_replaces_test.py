...
class ApplyStringReplacementsTest(unittest.TestCase):
    ...
    def test_rebrands_target_files(self):
        ...
        self.assertIn("Wayfinder", content)
        self.assertIn("The Wayfinder Authors. All rights reserved.", content)
    ...
    def test_google_play_is_preserved(self):
        ...
        self.assertNotIn("Wayfinder Play", content)
