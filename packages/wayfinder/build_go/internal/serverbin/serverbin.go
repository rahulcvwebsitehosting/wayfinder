...
// metadata for Wayfinder Server binaries, consumed by both the build signing
...
var MacOSServerBinaries = map[string]SignSpec{
	"wayfinder_server": {"wayfinder_server", "runtime", "wayfinder-executable-entitlements.plist"},
	"bun":              {"bun", "runtime", "wayfinder-executable-entitlements.plist"},
	"codex":            {"codex", "runtime", ""},
