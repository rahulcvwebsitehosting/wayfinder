...
import (
	...
	"github.com/wayfinder-browser/Wayfinder/packages/wayfinder/build_go/internal/modules/compile"
	"github.com/wayfinder-browser/Wayfinder/packages/wayfinder/build_go/internal/modules/extensions"
	"github.com/wayfinder-browser/Wayfinder/packages/wayfinder/build_go/internal/modules/patchmod"
	"github.com/wayfinder-browser/Wayfinder/packages/wayfinder/build_go/internal/modules/pkg"
	"github.com/wayfinder-browser/Wayfinder/packages/wayfinder/build_go/internal/modules/resources"
	"github.com/wayfinder-browser/Wayfinder/packages/wayfinder/build_go/internal/modules/setup"
	"github.com/wayfinder-browser/Wayfinder/packages/wayfinder/build_go/internal/modules/sign"
	"github.com/wayfinder-browser/Wayfinder/packages/wayfinder/build_go/internal/modules/storage"
	"github.com/wayfinder-browser/Wayfinder/packages/wayfinder/build_go/internal/modules/universal"
...
func (m notPorted) Validate(*buildctx.Context) error {
	return fmt.Errorf("module %s is not ported to Go yet — use `uv run wayfinder` meanwhile", m.name)
}
