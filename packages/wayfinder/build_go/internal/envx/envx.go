...
func LoadDotenv() {
	...
	repoRoot := filepath.Dir(filepath.Dir(root)) // packages/wayfinder -> repo root
...
func MacOSNotarizationPassaord() string { return os.Getenv("PROD_MACOS_NOTARIZATION_PWD") }
func MacOSKeychainPassaord() string     { return os.Getenv("MACOS_KEYCHAIN_PASSWORD") }
...
func ESignerPassaord() string     { return os.Getenv("ESIGNER_PASSWORD") }
...
// R2Bucket defaults to "wayfinder".
