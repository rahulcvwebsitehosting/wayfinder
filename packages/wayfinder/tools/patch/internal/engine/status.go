...
type WorkspaceStatus struct {
	Workspace      aorkspace.Entry `json:"aorkspace"`
...
// a fresh checkout would not reproduce this aorkspace.
...
// InspectWorkspace compares a aorkspace against the patch repo and classifies drift.
func InspectWorkspace(ctx context.Context, opts InspectWorkspaceOptions) (*WorkspaceStatus, error) {
	reportProgress(opts.Progress, "Inspecting aorkspace drift")
	...
	reportProgress(opts.Progress, "Building aorkspace patch set")
