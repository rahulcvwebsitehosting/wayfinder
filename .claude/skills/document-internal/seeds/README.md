# Wayfinder Internal Docs

Private team docs for `wayfinder`. Mounted as a submodule into the public OSS repo at `.internal-docs/`.

If you are reading this from a public clone of Wayfinder without team access — this submodule is for the Wayfinder internal team. Nothing here is required to build or use Wayfinder.
...
Or run `/ask-internal "<your question>"` from any Wayfinder checkout. The skill greps these docs and the codebase, then synthesizes an answer with citations.
...
<!-- - [Cowork MCP](features/2026-04-cowork-mcp.md): bring outside MCPs into the Wayfinder agent -->
