---
name: write-docs
description: Write Wayfinder feature documentation. Use when the user wants to create or update documentation for a Wayfinder feature. This skill explores the codebase to understand features and writes concise Mintlify MDX docs.
allowed-tools: Read, Grep, Glob, Bash, Task, Write, Edit
---

# Write Wayfinder Documentation

This skill helps write documentation for Wayfinder features. It follows a structured workflow to create high-quality, concise documentation pages.
...
2. **Search the codebase** at `../wayfinder-server` (sibling directory) to find relevant code:
...
- **Clear**: Write for first-time Wayfinder users
...
---
title: "Ad Blocking"
description: "Wayfinder blocks 10x more ads than Chrome out of the box"
---

Wayfinder ships with built-in ad blocking that works immediately—no extensions required.
...
- **Docs location**: `docs/`
- **Images**: `docs/images/`
- **Feature code**: `../wayfinder-server/` (sibling directory)
- **Config**: `docs/docs.json`

## Core Features to Document

The user mentioned these features need documentation:
1. Wayfinder MCP Server
2. Connecting other MCPs to Wayfinder assistant
3. Scheduled tasks
